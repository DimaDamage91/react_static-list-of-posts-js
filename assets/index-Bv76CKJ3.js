...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>R.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>R.jsxs("div",{className:"CommentInfo",children:[R.jsx("p",{className:"CommentInfo__body",children:e.body}),R.jsxs("p",{className:"CommentInfo__name",children:[R.jsx("strong",{children:"Commented by:"})," ",e.authorName]}),R.jsxs("p",{className:"CommentInfo__email",children:[R.jsx("strong",{children:"Email:"}),R.jsx("a",{href:`mailto:${e.email}`,children:e.email})]})]}),Tc=({comments:e})=>(e.sort((t,i)=>t.id-i.id),R.jsx("div",{className:"CommentList",children:e.length>0?e.map(t=>R.jsx(Lc,{comment:t},t.id)):R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})})),Mc=({post:e})=>R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e.title}),R.jsxs("p",{children:[" Posted by  ",R.jsx(Pc,{user:e.user})]})]}),R.jsx("p",{className:"PostInfo__body",children:e.body}),R.jsx("hr",{}),R.jsx(Tc,{comments:e.comments})]}),Rc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Mc,{post:t},t.id))}),Dc=()=>{const e=Cc.map(t=>{const i=Nc.find(a=>a.id===t.userId),n=zc.filter(a=>a.postId===t.id);return{...t,user:i,comments:n}});return R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{posts:e})]})};em(document.getElementById("root")).render(R.jsx(Dc,{}));
